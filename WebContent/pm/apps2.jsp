...
<h1> Applications <br><small>Select an application to manage it's profiles</small> 
</h1>
...
<ewaf:loop className="jfr.webapp.placeholdermanager.bean.ApplicationBean" scope="request" id="list">
	<tr>
		<td> <a href="<%= path %>/ewaf/listApplicationProfiles?appId=<%=loopObj.id %>"> <%= loopObj.appName %> </a></td>
